...
-- -
/*
Q1 Install the pub database
*/

/*
Q2 wtrite query that uses pub database and shows authors FirstName, LastName,Address,Phone
*/
select * from authors where city = 'California'

create view Questions2 as
select au_fname, au_lname, address,phone, city
from authors
where city = 'california';

/*
Q3 create a query that counts the number of records in the titles table that is part of the pubs database.
create into view and call the view recordcount.
*/
...
/*
Q4 create a query that joins the authors table to the titleauthor table and also joins the titles table show all fields. 
*/
...
select authors.au_id,titleautor.title_id,titles.title
from(( authors
inner join titleauthor ON authors.title_id = titleauthor.title_id)
inner join titles ON authors.title = titles.title);
...
select * from employeeselect * from publishers

select empolyee.emp_id,employee.fname,employess.lname,
publishers.pub_id,publishers.city,publishers.state from employee
inner join publishers on publishers.pub_id=emp_id where city='Washington'

/*
Q7
*/

create trigger tr_pubDatabase_delete on authors discount,employee, jobs, pub_info, publisher, roysched, sales, stores,titleauthor,titles
instead of delete as begin print 'delete not allowed' end

/*
Q8
*/

create trigger tr_SalesDelete_delete 
on sales 
instead of delete 
as 
begin 
print 'delet not allowed'
...
create procedure sp_question9multiply
as
begin
...
exec sp_question9mulitply

drop procedure sp_question9multiply
...
create nonclustered index ix_nc1_authors
on authors(au_id, au_fname, au_lname, phone)